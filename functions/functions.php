...
$con = mysqli_connect("localhost","root","","HKBK Shop");
	...
	global $con;
	   ...
	   $check_pro = "select * from cart where ip_add='$ip' AND p_id='$pro_id'";
		...
		if(mysqli_num_rows($run_check)>0){
			...
			echo "<b>Product already added</b>";
...
//Getting the total pricce of the items in the cart
...
if(isset($_GET['brand'])) {
	...
	if($counts_brands==0){
		...
		echo"<h2 style='padding:20px;'>There are no products associated with this Brand!</h2>";
